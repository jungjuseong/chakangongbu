...
%>
            <!-- header -->
            <div class="header">
                <a href="#none" onclick="close_window()" class="btn-back"><span>뒤로가기</span></a>
            ...
            <div id="skipCont" class="contents">
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="good_name" value="멤버쉽" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_name" value="김착한" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
...
%>
                ...
                <ul class="list-btn-2">
                    ...
                    <li class="pc-only-show"><a href="#none" onclick="close_window()" class="btn-type-3 pc-wd-2">뒤로</a></li>
